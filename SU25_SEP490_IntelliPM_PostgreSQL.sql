...
VALUES 
    ('user1', 'Nguyen Van A', 'user1@example.com', 'pass123', 'PM', 'PM', '0901234567', 'Male', 'google1', 'AC', 'Ha Noi', NULL),
    ('user2', 'Tran Thi B', 'user2@example.com', 'pass456', 'TM', 'BE', '0907654321', 'Female', 'google2', 'AC', 'Ho Chi Minh', NULL),
    ('user3', 'Le Van C', 'user3@example.com', 'pass789', 'TM', 'TS', '0912345678', 'Male', NULL, 'IN', 'Da Nang', NULL),
    ('user4', 'Pham Thi D', 'user4@example.com', 'pass101', 'TM', 'DS', '0923456789', 'Female', 'google4', 'AC', 'Can Tho', NULL),
    ('user5', 'Hoang Van E', 'user5@example.com', 'pass112', 'PM', 'PM', '0934567890', 'Male', 'google5', 'AC', 'Hai Phong', NULL);
