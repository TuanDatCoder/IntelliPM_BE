...
namespace IntelliPM.Services.EmailServices
{
    public interface IEmailService
    {
        ...
        Task SendProjectCreationNotification(string pmFullName, string pmEmail, string creatorFullName, string creatorUsername, int projectId, string projectDetailsUrl);
